...
/// @brief Imu2 message callback
/// @param imu_msgs aerial_robot_msgs::Imu2ConstPtr
void ImuVisualization::imu2Callback(const aerial_robot_msgs::Imu2ConstPtr& imu_msg)
{
  imuDataStamp = imu_msg->stamp;

  tf::Transform baseToImu;

  q.setValue(imu_msg->q[1], imu_msg->q[2],imu_msg->q[3], imu_msg->q[0]);
