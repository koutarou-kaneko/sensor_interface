...
#define MINTHROTTLE 1220 // for Turnigy Plush ESCs 10A
...
#define TRI_YAW_MIDDLE MIDRC // (*) tail servo center pos. - use this for initial trim; later trim midpoint via LCD
  ...
  /***********************          Cam Stabilisation             ***********************/
    ...
    #define TILT_PITCH_MIDDLE MIDRC    //servo neutral value
  ...
  /***********************          Flying Wing                   ***********************/
    ...
    #define WING_LEFT_MID  MIDRC // left servo center pos. - use this for initial trim; later trim midpoint via LCD
    #define WING_RIGHT_MID MIDRC // right servo center pos. - use this for initial trim; later trim midpoint via LCD
  ...
  /***********************          Airplane                       ***********************/
    ...
    #define FLAPPERON_EP   { MIDRC, 1700 } // Endpooints for flaps on a 2 way switch else set {1020,2000} and program in radio.
    ...
    #define FLAP_EP      { MIDRC, 1900 }   // Endpooints for flaps on a 2 way switch else set {1020,2000} and program in radio.
