...
void LoadDefaults() {
  uint8_t i;
    ...
    conf.pid[ROLL].P8     = 33; //prev: 33
    conf.pid[ROLL].I8    = 30; conf.pid[ROLL].D8     = 23;
    conf.pid[PITCH].P8    = 33;//prev: 33
    conf.pid[PITCH].I8    = 30; conf.pid[PITCH].D8    = 23;
    conf.pid[YAW].P8      = 68;  conf.pid[YAW].I8     = 45;  conf.pid[YAW].D8     = 0;
    conf.pid[PIDALT].P8   = 64; conf.pid[PIDALT].I8   = 25; conf.pid[PIDALT].D8   = 24;
  
    conf.pid[PIDLEVEL].P8 = 90; //prev :90
    conf.pid[PIDLEVEL].I8 = 10; conf.pid[PIDLEVEL].D8 = 100;
