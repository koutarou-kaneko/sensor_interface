...
#define ROS_ARM_ON_CMD           0x20   //arming on
#define ROS_ARM_OFF_CMD          0x21   //arming off
#define ROS_DROP_CMD             160   //servo turning cmd 

#define ROS_ROLL_PITCH_PD_P_UP        161
#define ROS_ROLL_PITCH_PD_P_DOWN      162
#define ROS_ROLL_PD_D_UP        163
#define ROS_ROLL_PD_D_DOWN      164
#define ROS_PITCH_PD_D_UP        167
#define ROS_PITCH_PD_D_DOWN      168

#define ROS_YAW_D_UP        165
#define ROS_YAW_D_DOWN      166
...
#else
  static uint8_t CURRENTPORT=SERIAL_COM_PORT;
#endif
...
#ifdef USE_HARDWARESERIAL
      // if tx buffer is not have margin, return.
      // not implemented       
#else// USE_HARDWARESERIAL
...
void serialize8(uint8_t a) {
  switch (CURRENTPORT) {
#ifdef USE_ROS
  // rosserial use Serial
#else// USE_ROS
  case 0: Serial.write(a);  break;
#endif// USE_ROS
  case 1: Serial1.write(a);  break;
  case 2: Serial2.write(a);  break;
  case 3: Serial3.write(a);  break;
  }
...
#ifdef USE_HARDWARESERIAL
// ISR() is defined in HardwareSerial.cpp
#else// USE_HARDWARESERIAL
#ifdef USE_ROS
#else// USE_ROS
...
#ifdef USE_HARDWARESERIAL
void UartSendData() {
// UDRIEn is defined in HardwareSerial.cpp
}
#else// USE_HARDWARESERIAL
void UartSendData() {
  #if defined(PROMINI)
...
#ifdef USE_HARDWARESERIAL
// input buffer process is defined in HardwareSerial.cpp
#else// USE_HARDWARESERIAL
...
static uint8_t debugmsg_available() {
  if (head_debug >= tail_debug) {
    ...
    reSturn head_debug + (DEBUG_MSG_BUFFER_SIZE-tail_debug);
  }
}
