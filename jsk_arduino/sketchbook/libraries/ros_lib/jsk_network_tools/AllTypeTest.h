  ...
  class AllTypeTest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_int64_arrayi.base >> (8 * 7)) & 0xFF;
      ...
      u_uint64_atom.real = this->uint64_atom;
      *(outbuffer + offset + 0) = (u_uint64_atom.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_uint64_atom.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_uint64_atom.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_uint64_atom.base >> (8 * 3)) & 0xFF;
      ...
      u_uint64_arrayi.real = this->uint64_array[i];
      *(outbuffer + offset + 0) = (u_uint64_arrayi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_uint64_arrayi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_uint64_arrayi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_uint64_arrayi.base >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_uint64_atom.base = 0;
      u_uint64_atom.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_uint64_atom.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_uint64_atom.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_uint64_atom.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->uint64_atom = u_uint64_atom.real;
      offset += sizeof(this->uint64_atom);
      for( uint8_t i = 0; i < 4; i++){
      union {
        uint64_t real;
      ...
      u_uint64_arrayi.base = 0;
      u_uint64_arrayi.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_uint64_arrayi.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_uint64_arrayi.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_uint64_arrayi.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->uint64_array[i] = u_uint64_arrayi.real;
      offset += sizeof(this->uint64_array[i]);
      }
      union {
        float real;
