...
namespace hrpsys_gazebo_msgs
{
  ...
  class RobotState : public ros::Msg
  {
    public:
      ...
      float st_ref_position;
      float * ref_position;
      uint8_t ref_velocity_length;
      float st_ref_velocity;
      float * ref_velocity;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->ref_position[i]);
      }
      ...
      *(outbuffer + offset++) = 0;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->ref_velocity[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(ref_position_lengthT > ref_position_length)
        this->ref_position = (float*)realloc(this->ref_position, ref_position_lengthT * sizeof(float));
      offset += 3;
      ref_position_length = ref_position_lengthT;
      for( uint8_t i = 0; i < ref_position_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_ref_position));
        memcpy( &(this->ref_position[i]), &(this->st_ref_position), sizeof(float));
      }
      uint8_t ref_velocity_lengthT = *(inbuffer + offset++);
      if(ref_velocity_lengthT > ref_velocity_length)
        this->ref_velocity = (float*)realloc(this->ref_velocity, ref_velocity_lengthT * sizeof(float));
      offset += 3;
      ref_velocity_length = ref_velocity_lengthT;
      for( uint8_t i = 0; i < ref_velocity_length; i++){
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->st_ref_velocity));
        memcpy( &(this->ref_velocity[i]), &(this->st_ref_velocity), sizeof(float));
      }
