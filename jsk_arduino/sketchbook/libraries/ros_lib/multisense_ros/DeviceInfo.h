  ...
  class DeviceInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 1) = (this->firmwareVersion >> (8 * 1)) & 0xFF;
      ...
      u_bitstreamVersion.real = this->bitstreamVersion;
      *(outbuffer + offset + 0) = (u_bitstreamVersion.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_bitstreamVersion.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_bitstreamVersion.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_bitstreamVersion.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->bitstreamVersion);
      union {
        uint64_t real;
        uint32_t base;
      } u_bitstreamMagic;
      u_bitstreamMagic.real = this->bitstreamMagic;
      *(outbuffer + offset + 0) = (u_bitstreamMagic.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_bitstreamMagic.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_bitstreamMagic.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_bitstreamMagic.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->bitstreamMagic);
      union {
        uint64_t real;
        uint32_t base;
      } u_fpgaDna;
      u_fpgaDna.real = this->fpgaDna;
      *(outbuffer + offset + 0) = (u_fpgaDna.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_fpgaDna.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_fpgaDna.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_fpgaDna.base >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_bitstreamVersion.base = 0;
      u_bitstreamVersion.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_bitstreamVersion.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_bitstreamVersion.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_bitstreamVersion.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->bitstreamVersion = u_bitstreamVersion.real;
      offset += sizeof(this->bitstreamVersion);
      union {
        uint64_t real;
        uint32_t base;
      } u_bitstreamMagic;
      u_bitstreamMagic.base = 0;
      u_bitstreamMagic.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_bitstreamMagic.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_bitstreamMagic.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_bitstreamMagic.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->bitstreamMagic = u_bitstreamMagic.real;
      offset += sizeof(this->bitstreamMagic);
      union {
        uint64_t real;
        uint32_t base;
      ...
      u_fpgaDna.base = 0;
      u_fpgaDna.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_fpgaDna.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_fpgaDna.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_fpgaDna.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->fpgaDna = u_fpgaDna.real;
      offset += sizeof(this->fpgaDna);
     return offset;
    }
